class Tag < ActiveRecord::Base
  ...
  validates_format_of :name, :with => /[a-zA-Z0-9][\_\-\' ]?/, :message => "Must start with a letter or number and can contain underscores, hyphens and apostrophes"
  validates_length_of :name, :minimum => 2
  validates_cleanliness_of :name
