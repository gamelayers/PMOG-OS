...
$().ready(function() {
    $('#dialog1').jqm({overlay: 50, modal: false, trigger: '.dialog1'});
    ...
    $('a.alert1').click(function() {
        alert('You have triggered an alert! Look how cool this is! OMG! You <em>must</em> click OK or the close button to close an alert!');
        return false;
    });

    // ALERT for #2
    $('a.alert2').click(function() {
        alert('You have triggered another alert! It\'s like, so cool! OMG! Remember to click OK to close this!');
        return false;
    });
...
/*    // ADD CONFIRMS
    ...
    $('a.confirm1').click(function() {
        confirm('Now you will be linked to install The Nethernet toolbar!  It is an extension for the Firefox web browser.');
        return false;
    });*/
